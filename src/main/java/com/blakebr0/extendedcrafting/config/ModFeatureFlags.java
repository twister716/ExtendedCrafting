...
public final class ModFeatureFlags {
    ...
    public static final FeatureFlag RECIPE_MAKER_USE_NBT = FeatureFlag.create(ExtendedCrafting.resource("recipe_maker_use_nbt"), ModConfigs.RECIPE_MAKER_USE_NBT);
